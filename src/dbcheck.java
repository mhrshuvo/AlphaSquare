...
//
//    private static final String CreateDbAT="CREATE TABLE admin("
//            + "UID INT NOT NULL,"
...
//    private static final String url = "jdbc:mysql://localhost:3306/lbms_alpha";
//    private static final String privilages = "root";
...
////            stm.executeUpdate(CreateDbAT);
//
////uncomment for set admin password
////            String admin = "INSERT INTO `admin` VALUES ( 1,'admin','1234','psnbshuvfdo@gmail.com')";
...
//
//            String admin ="admin";
//            ResultSet log = stm.executeQuery("SELECT * FROM `admin`");
//            while(log.next()){
//                System.out.println(log.getString("NAME"));
//
//            }
//
//
